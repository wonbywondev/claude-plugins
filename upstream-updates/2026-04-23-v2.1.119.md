...
applied: true
impact: "none"
notes: "preserve-session: classified as none — PostToolUse duration_ms field and /config persist-to-settings.json don't affect SessionStart-only plugin; no MCP servers, no PostToolUse hooks, no worktree agents. tracked in plugins/preserve-session/upstream.md"
---
...
## Plugin-relevant keyword hits (9)
