...
applied: true
impact: "none"
notes: "preserve-session: classified as none — cleanupPeriodDays sweep extended to tasks/shell-snapshots/backups dirs but ~/.claude/projects/ unchanged; hook/command/registry/slug unaffected. tracked in plugins/preserve-session/upstream.md"
---
